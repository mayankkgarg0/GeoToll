...
public class TesData {
	  ...
	  @DataProvider(name = "loginData")
	    ...
	    public Object[][] loginDataProvider() throws IOException {
	    	//ReadFromExcel excelUtil = new ReadFromExcel("C:\\Users\\dell\\eclipse-workspace\\GeoTollUATCommandLine\\GeoTollExcelLogin.xlsx"); 
	    	ReadFromExcel excelUtil = new ReadFromExcel("C:\\Users\\dell\\eclipse-workspace\\GeoTollUATCommandLine\\GeoTollExcelMRO.xlsx"); 
